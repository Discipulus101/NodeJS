// Программа переводчик с английского на русский, реализованная с помощью Callback
...
function translate () {
    ...
    rl.on('line', (line) => {
        if (line === 'q') { // Условие для завершения программы
            ...
            textTranslationRequest() //Вызов функции перевода
        }
    })
}

function textTranslationRequest () {
